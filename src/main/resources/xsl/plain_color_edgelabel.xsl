...
<xsl:text>Vertex/.style={circle, draw, line width=2.0, fill=white, minimum size=\Scaling*1.75cm},
Seed/.style={circle, draw, line width=2.0, fill=SeminarRot, minimum size=\Scaling*2cm},
